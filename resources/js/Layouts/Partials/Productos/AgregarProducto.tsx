...
const AgregarProducto: React.FC<AgregarProductoProps> = ({ categorias, motos }) => {
  ...
  const [nuevaImagen, setNuevaImagen] = useState<ImagenAdicional>({
    url: "",
    estilo: ""
  });
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    setData(name as keyof typeof data, type === "checkbox" ? (checked as boolean) : value);
  };
  ...
  const agregarImagenAdicional = () => {
    if (nuevaImagen.url && imagenesAdicionales.length < MAX_IMAGENES_ADICIONALES) {
  ...
  const eliminarImagenAdicional = (index: number) => {
    ...
    setData("imagenes_adicionales", JSON.stringify(nuevasImagenes));
  };
          ...
          >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {data.descripcion_corta.length}/{MAX_DESCRIPCION_CORTA} caracteres
                    </p>
                  </div>
            ...
            <TabsContent value="precios" className="space-y-6">
              {precioExcedido && (
                <Alert variant="destructive">
                  ...
                  <AlertTitle>Precio excedido</AlertTitle>
                  <AlertDescription>
                    El precio no puede ser mayor a {formatCurrencyDisplay(PRECIO_MAXIMO)}. Por favor ajuste el valor.
                  </AlertDescription>
                </Alert>
              )}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Precio máximo permitido: {formatCurrencyDisplay(PRECIO_MAXIMO)}
                      </p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {precioExcedido ? "N/A" : formatCurrencyDisplay(precioSinIGV)}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">IGV (18%):</span>
                        <span className="font-medium">
                          {precioExcedido ? "N/A" : formatCurrencyDisplay(precioConIGV - precioSinIGV)}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-lg text-indigo-700">
                          {precioExcedido ? "N/A" : formatCurrencyDisplay(precioTotal)}
                        </span>
                      </div>
                      {data.descuento !== "0" && (
            ...
            <TabsContent value="imagenes" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label className="text-sm font-medium">Imágenes Adicionales (Máx. 10)</Label>
                    ...
                    {nuevaImagen.url && (
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          disabled={!nuevaImagen.url || imagenesAdicionales.length >= MAX_IMAGENES_ADICIONALES}
                    ...
                    <p className="text-xs text-muted-foreground">
                      {imagenesAdicionales.length}/{MAX_IMAGENES_ADICIONALES} imágenes adicionales
                    </p>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="categorias" className="space-y-6">
              ...
              <div className="flex justify-between mt-8">
                ...
                <Button
                  type="submit"
                  disabled={processing || precioExcedido}
